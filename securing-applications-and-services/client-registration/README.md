...
The bearer token can be issued on behalf of a user or a Service Account. The following permissions are required to invoke the endpoints (see [Server Administration](https://keycloak.gitbooks.io/documentation/content/server\_admin/index.html) for more details):
...
If you are using a bearer token to create clients it’s recommend to use a token from a Service Account with only the `create-client` role (see [Server Administration](https://keycloak.gitbooks.io/documentation/content/server\_admin/index.html) for more details).
...
#### Keycloak Representations <a href="#keycloak_representations" id="keycloak_representations"></a>
...
#### Keycloak Adapter Configuration <a href="#keycloak_adapter_configuration" id="keycloak_adapter_configuration"></a>
...
#### OpenID Connect Dynamic Client Registration <a href="#openid_connect_dynamic_client_registration" id="openid_connect_dynamic_client_registration"></a>

Keycloak implements [OpenID Connect Dynamic Client Registration](https://openid.net/specs/openid-connect-registration-1\_0.html), which extends [OAuth 2.0 Dynamic Client Registration Protocol](https://tools.ietf.org/html/rfc7591) and [OAuth 2.0 Dynamic Client Registration Management Protocol](https://tools.ietf.org/html/rfc7592).
...
#### SAML Entity Descriptors <a href="#saml_entity_descriptors" id="saml_entity_descriptors"></a>
...
#### Example using Java Client Registration API <a href="#example_using_java_client_registration_api" id="example_using_java_client_registration_api"></a>
...
#### Client Registration Policies <a href="#client_registration_policies" id="client_registration_policies"></a>
